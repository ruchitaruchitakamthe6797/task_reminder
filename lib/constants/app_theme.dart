...
import 'package:send_remider_to_user/constants/font_family.dart';
...
final ThemeData themeData = ThemeData(
  ...
  primarySwatch:
      MaterialColor(AppColors.violet.value, AppColors.appBlueMaterial),
    ...
    fillColor: MaterialStateColor.resolveWith(
      (states) {
        if (states.contains(MaterialState.selected)) {
          return AppColors.violet; // the color when checkbox is selected;
        }
  ...
  checkboxTheme: CheckboxThemeData(
    fillColor: MaterialStateColor.resolveWith(
      (states) {
        ...
        return Colors.white70; //the color when checkbox is unselected;
      },
    ),
  ),
  textTheme: TextTheme(
